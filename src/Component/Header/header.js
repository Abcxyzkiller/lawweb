...
export default class Header extends Component {
  ...
  render() {
    return (
      <div className="container-fluid header "style={{background: "black", color: "white", padding: "14px",fontSize: "12px" }}>
        <div className="col-md-10">
              <span className="glyphicon glyphicon-phone" style ={{marginRight: "5px" }} ></span>
